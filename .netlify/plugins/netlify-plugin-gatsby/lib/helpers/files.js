...
exports.relocateBinaries = exports.checkPackageVersion = exports.findModuleFromBase = exports.patchFile = void 0;
...
const relocateBinaries = async (baseDir) => {
    ...
    if (currentAbi === DEFAULT_LAMBDA_ABI &&
    ...
    let lmdbPath = (0, exports.findModuleFromBase)({
    ...
    const lmdbPrebuilds = (0, pathe_1.resolve)(lmdbPath, 'prebuilds', LAMBDA_PLATFORM);
    const binaryTarget = (0, pathe_1.resolve)(baseDir, '.cache', 'query-engine', 'assets', 'prebuilds', LAMBDA_PLATFORM);
