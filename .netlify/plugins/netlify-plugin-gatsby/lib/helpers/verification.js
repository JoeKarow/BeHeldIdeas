...
const checkZipSize = async (file, maxSize = exports.LAMBDA_MAX_SIZE) => {
    ...
    console.log((0, chalk_1.redBright)((0, common_tags_1.stripIndent) `
      The function zip ${(0, chalk_1.yellowBright)((0, pathe_1.relative)(process_1.default.cwd(), file))} size is ${(0, pretty_bytes_1.default)(fileSize)}, which is larger than the maximum supported size of ${(0, pretty_bytes_1.default)(maxSize)}.
